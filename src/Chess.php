...
/**
 * Chess validation, move generation, and much more.
 */
class Chess extends Config
{
    protected $board;
    protected $kings;
    protected $turn;
    ...
    /**
     * Get the FEN of the current position and other game data, or just position.
     *
     * @param bool $onlyPosition Should we only retrive the position.
     *
     * @return string The current FEN.
     */
